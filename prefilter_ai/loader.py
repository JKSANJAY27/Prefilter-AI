"""
Model loader: downloads and caches the fine-tuned adapter.
...
Users can force a strategy via the `backend` parameter of PrefilterAI().
"""
...
from prefilter_ai.config import BASE_MODEL_ID, DEFAULT_MODEL_IDS, ModelFormat
from prefilter_ai.exceptions import ModelLoadError
